...
const translations = {
  ...
  id: {
    ...
    install_run_t: 'Cara Menjalankan',
    ...
    install_os_note: '<strong class="warn-strong">Penting — Dukungan OS:</strong> SpoLyrics <strong>eksklusif untuk Windows</strong> (10/11). Karena memakai <code>winsdk</code> untuk performa 0-delay tanpa server pihak ketiga, aplikasi ini <strong>tidak bisa</strong> diinstal di macOS atau Linux.',
